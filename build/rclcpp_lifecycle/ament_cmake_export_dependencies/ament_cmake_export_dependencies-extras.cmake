...
set(_exported_dependencies "lifecycle_msgs;rcl;rclcpp;rcl_interfaces;rcl_lifecycle;rcutils;rosidl_typesupport_cpp")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rclcpp_lifecycle_INCLUDE_DIRS "${_include_dirs}")
          endif()
