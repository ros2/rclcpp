...
bool rclcpp__msg__string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rclcpp.msg._string.String", full_classname_dest, 25) == 0);
  }
  rclcpp__msg__String * ros_message = _ros_message;
  {  // data
...
PyObject * rclcpp__msg__string__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rclcpp.msg._string");
