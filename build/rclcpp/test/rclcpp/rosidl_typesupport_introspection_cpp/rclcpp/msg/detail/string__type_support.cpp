...
{
  new (message_memory) rclcpp::msg::String(_init);
}

void String_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rclcpp::msg::String *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember String_message_member_array[1] = {
  {
    ...
    offsetof(rclcpp::msg::String, data),  // bytes offset in struct
...
{
  return &::rclcpp::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rclcpp, msg, String)() {
  return &::rclcpp::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
