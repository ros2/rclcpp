  ...
  notify_guard_condition_is_valid_(false)
{
  ...
  node_handle_.reset(rcl_node.release(), [](rcl_node_t * node) -> void {
...
bool NodeBase::assert_liveliness() const
{
  return RCL_RET_OK == rcl_node_assert_liveliness(get_rcl_node_handle());
}

rclcpp::callback_group::CallbackGroup::SharedPtr NodeBase::create_callback_group(
...
rclcpp::callback_group::CallbackGroup::SharedPtr NodeBase::get_default_callback_group()
{
  return default_callback_group_;
}

bool NodeBase::callback_group_in_node(rclcpp::callback_group::CallbackGroup::SharedPtr group)
{
...
const std::vector<rclcpp::callback_group::CallbackGroup::WeakPtr> & NodeBase::get_callback_groups()
  const
{
...
rcl_guard_condition_t * NodeBase::get_notify_guard_condition()
{
  std::lock_guard<std::recursive_mutex> notify_condition_lock(notify_guard_condition_mutex_);
...
std::unique_lock<std::recursive_mutex> NodeBase::acquire_notify_guard_condition_lock() const
{
