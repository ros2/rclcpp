...
// TODO(dabonnie) fix when period is configurable
constexpr const std::chrono::seconds kTestDuration{20};
}  // namespace
...
TEST_F(TestSubscriberTopicStatisticsFixture, test_receive_single_empty_stats_message)
{
