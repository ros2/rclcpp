...
protected:
    ...
    std::function<rclcpp::AnyExecutable(WeakCallbackGroupsToNodesMap)> get_next_entity_func)
  {
    ...
    WeakCallbackGroupsToNodesMap weak_groups_to_nodes;
    basic_node->callback_groups_for_each(
    ...
    node_with_entity1->callback_groups_for_each(
    ...
    basic_node2->callback_groups_for_each(
    ...
    node_with_entity2->callback_groups_for_each(
      [node_with_entity2,
    ...
    std::function<rclcpp::AnyExecutable(WeakCallbackGroupsToNodesMap)> get_next_entity_func)
  {
    ...
    WeakCallbackGroupsToNodesMap weak_groups_to_nodes;
    basic_node_base->callback_groups_for_each(
    ...
    node_base->callback_groups_for_each(
