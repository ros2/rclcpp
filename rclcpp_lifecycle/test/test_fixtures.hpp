 ...
 * @brief Shared test fixtures for lifecycle node enhancement tests
 *
 * This header provides common test fixtures and utilities for testing
 * the enhanced lifecycle node functionality in rclcpp_lifecycle.
 *
