...
: ${AMENT_CURRENT_PREFIX:="/Users/cursedrock17/Documents/Coding/CPP/ros2/rclcpp/install/rclcpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rclcpp/environment/library_path.sh"
