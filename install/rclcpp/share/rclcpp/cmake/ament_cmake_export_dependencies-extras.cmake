...
set(_exported_dependencies "ament_index_cpp;libstatistics_collector;rcl;rcpputils;rcutils;builtin_interfaces;rosgraph_msgs;rosidl_typesupport_cpp;rosidl_typesupport_c;rosidl_runtime_cpp;rcl_yaml_param_parser;statistics_msgs;tracetools")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rclcpp_INCLUDE_DIRS "${_include_dirs}")
          endif()
